...
<div class="@if(get_setting('header_stikcy') == 'on') position-fixed @else position-absolute @endif w-100 top-0 z-1020">
    <div class="top-navbar bg-white border-bottom z-1035 py-2 d-none d-lg-block"><!--1st line/comman line for all page of header-->
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col"><!--column of frist line of header-->
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0"><!--width of first line of code-->
                    ...
                    <ul
                        ...
                        <li class="d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['home'],'bg-primary-grad') }}">
                            <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2"
                                href="{{ route('home') }}">
                                <span class="text-primary-grad mb-n1">{{ translate('Homes') }}</span>
                            </a>
                        </li>
                        <li
